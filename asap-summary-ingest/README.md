...
Given `streaming_config.yaml` (generated by asap-planner-rs), asap-summary-ingest:
...
This automation eliminates manual pipeline creation and ensures consistency with asap-planner-rs decisions.

## How It Works

### Input: streaming_config.yaml

The asap-planner-rs generates this file describing which sketches to build:
