...
This automation eliminates manual pipeline creation and ensures consistency with asap-planner decisions.

## How It Works

### Input: streaming_config.yaml

The asap-planner generates this file describing which sketches to build:
