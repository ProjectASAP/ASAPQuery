...
fn assert_index_schema(
    ...
    match inference_config.schema {
        SchemaConfig::ElasticQueryDSL(schema) => {
            assert_eq!(schema.get_time_field(index), Some(&"@timestamp".to_string()));
...
"#;
        ...
        assert_eq!(out.aggregation_table_name("CountMinSketch"), Some("metrics".to_string()));
        assert_eq!(out.aggregation_value_column("CountMinSketch"), Some("cpu_usage".to_string()));
...
"#;
        ...
        assert!(!out.has_aggregation_type("DeltaSetAggregator"));
        assert!(out.all_tumbling_window_sizes_eq(300));
        assert_eq!(out.aggregation_table_name("MultipleSum"), Some("metrics".to_string()));
        assert_eq!(out.aggregation_value_column("MultipleSum"), Some("cpu_usage".to_string()));
...
"#;
        ...
        assert!(!out.has_aggregation_type("DeltaSetAggregator"));
        assert!(out.all_tumbling_window_sizes_eq(300));
        assert_eq!(out.aggregation_table_name("MultipleMinMax"), Some("metrics".to_string()));
        assert_eq!(out.aggregation_value_column("MultipleMinMax"), Some("cpu_usage".to_string()));
...
"#;
        ...
        assert!(!out.has_aggregation_type("DeltaSetAggregator"));
        assert!(out.all_tumbling_window_sizes_eq(300));
        assert_eq!(out.aggregation_table_name("DatasketchesKLL"), Some("metrics".to_string()));
        assert_eq!(out.aggregation_value_column("DatasketchesKLL"), Some("latency_ms".to_string()));
